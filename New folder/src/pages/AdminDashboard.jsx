...
const AdminDashboard = () => {
  ...
  // â”€â”€ Loading state per section â”€â”€
  const [loadingKpi,      setLoadingKpi]      = useState(true);
  const [loadingPending,  setLoadingPending]  = useState(true);
  const [loadingReports,  setLoadingReports]  = useState(true);
  const [loadingActivity, setLoadingActivity] = useState(true);

  // â”€â”€ Error state per section â”€â”€
  ...
  // â”€â”€ Action loading (approve / reject / remove) â”€â”€
  const [loadingId, setLoadingId] = useState(null);
  const [toast,     setToast]     = useState(null);

  // â”€â”€ Activity data shaped for chart (day label depends on lang) â”€â”€
  ...
  // â”€â”€ Initial load (parallel) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  useEffect(() => {
    fetchKpi();
    fetchPending();
    fetchReports();
  ...
  return (
    ...
    >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-10">
        ...
        {/* â•â•â•â•â•â•â•â•â•â•â•â•â• ROLE BADGE â•â•â•â•â•â•â•â•â•â•â•â•â• */}
        ...
        {/* â•â•â•â•â•â•â•â•â•â•â•â•â• KPI CARDS â•â•â•â•â•â•â•â•â•â•â•â•â• */}
        <section>
          {errorKpi ? (
        ...
        {/* â•â•â•â•â•â•â•â•â•â•â•â•â• PENDING TEACHER VERIFICATIONS â•â•â•â•â•â•â•â•â•â•â•â•â• */}
        ...
        {/* â•â•â•â•â•â•â•â•â•â•â•â•â• CONTENT MODERATION & REPORTS â•â•â•â•â•â•â•â•â•â•â•â•â• */}
        <section className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100
          dark:border-gray-700 shadow-sm overflow-hidden">
        ...
        {/* â•â•â•â•â•â•â•â•â•â•â•â•â• PLATFORM ACTIVITY CHART â•â•â•â•â•â•â•â•â•â•â•â•â• */}
        <section className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100
